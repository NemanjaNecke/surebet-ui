...
export const PREVIEW_SNAPSHOT: DashboardSnapshot = {
  ...
  opportunities: [
    {
      id: 'preview-1', kind: 'same-market', pair: null, market: '1X2', period: 'FT', line: null, scope: 'live', fixture: 'Partizan — Crvena zvezda',
      ...
      legs: [
        { label: '1', bookmaker: 'Mozzart', odds: 3.05, line: null },
        { label: 'X', bookmaker: 'MaxBet', odds: 3.7, line: null },
        { label: '2', bookmaker: 'Admiral', odds: 2.65, line: null },
      ],
    },
    {
      id: 'preview-2', kind: 'cross-market', pair: '1X vs 2', market: 'DC', period: 'FT', line: null, scope: 'prematch', fixture: 'Novi Pazar — Vojvodina',
      league: 'Serbia · SuperLiga', kickoff: new Date(Date.now() + 41 * 60_000).toISOString(),
      roi: 4.87, profit: 48.7, ageSeconds: 7,
      liveState: null,
      legs: [
        { label: '1X', bookmaker: 'SoccerBet', odds: 1.93, line: null },
        { label: '2', bookmaker: 'Meridian', odds: 2.25, line: null },
      ],
    },
    {
      id: 'preview-3', kind: 'same-market', pair: null, market: '2-Way', period: 'FT', line: null, scope: 'prematch', fixture: 'Budućnost — Borac Banja Luka',
      league: 'Adriatic League', kickoff: new Date(Date.now() + 63 * 60_000).toISOString(),
      roi: 3.91, profit: 39.1, ageSeconds: 11,
      liveState: null,
      legs: [
        { label: '1', bookmaker: 'Volcano', odds: 2.12, line: null },
        { label: '2', bookmaker: 'WWin', odds: 2.08, line: null },
      ],
    },
  ],
  bookmakers: [
